...
- GAL pins 14-16 feed HCT541 channels 6-8. The GAL's guaranteed 2.4 V HIGH is insufficient for direct AS6C1008 CMOS inputs.
- HCT541 also translates CLK, BUSREQ#, MCP CS#, SCK, and SI. Keep HCT541 on the Core board so its Z80 clock path stays local.
...
- Core: supply clearance 1-3, HCT541 8-17, Z80 19-38.
...
- Qualify at 1 MHz first, then 2-4 MHz in 500 kHz steps.
- The CPU's 20 MHz grade is not a system rating. Worst-case GAL + HCT541 + SRAM control-to-data delay is about 99 ns before breadboard and setup margin.
- Safe I/O trapping is measured behavior because there is no hardware WAIT# or deterministic combinational clock gate.
